...
import { formatValue, getLastState, isValueType, setLastState } from '../utils';
        ...
        <>
            <div className="object-field-viewer">
                <span className="name">
                    {!valueType ?
                        isExpanded ?
                            <i className="fas fa-chevron-down clickable" onClick={() => updateExpanded(false)}></i> :
                            <i className="fas fa-chevron-right clickable" onClick={() => updateExpanded(true)}></i> :
